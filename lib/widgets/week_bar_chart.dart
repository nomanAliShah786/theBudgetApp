...
class WeekBarChart extends StatefulWidget {
  ...
  WeekBarChart({List<TransactionModel> transactions}) : _transactions = transactions;
...
class WeekBarChartState extends State<WeekBarChart> {
  ...
  double _calculateTotal() {
    ...
    double sum = 0;
    for (TransactionModel transaction in widget._transactions) {
    ...
    return BarChartData(
      ...
      titlesData: FlTitlesData(
          ...
          bottomTitles: AxisTitles(
            ...
            showTitles: true,
            // getTextWidgets: (context, value) => TextStyle(
            //   color: Theme.of(context).primaryColor,
            //   fontWeight: FontWeight.bold,
            //   fontSize: 14,
            // ),
